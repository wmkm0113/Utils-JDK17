...
public final class ServiceUtils {
	 ...
	 */
	private record RestfulInterceptor(String requestPath, ClientBuilder clientBuilder, Map<String, String> headerMap)
		...
		private Response initResponse(final HttpMethodOption methodOption, final Invocation.Builder builder,
			...
			return switch (methodOption) {
				...
				default -> throw new ServiceException(0x0000000F0002L);
			};
		}
